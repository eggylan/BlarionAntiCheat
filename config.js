export default
	{
	"packetSenderId":"crasin:anticheatlite",
	"resetDp": true,
	"debug": false,
	"scanDelay":1,
	...
	*/
	...
	"modules": {
		...
		"autoclickerB": {
			"description": "Checks for very stable CPS.",
			"enabled": false,
			"minCPS": 5,
			"varianceRange": 0.01,
			"stableLength": 5,
		...
		"fly0": {
			"description": "(outdated) Check and cancel for player enabling fly illegal (For version below 1.21)",
			"enabled": true,
			"punishment": "kick",
			"minVlbeforePunishment": 5
		},
		...
		"flyB": {
			"description": "(outdated) Check for player's up distance (For version below 1.21)",
			"enabled": false,
			"punishment": "none",
			"minVlbeforePunishment": 0
		},
		...
		"reachA": {
			"description": "Long reach level check",
			"enabled": true,
			"reach": 5.6,
			"entities_blacklist": [
				"minecraft:enderman",
